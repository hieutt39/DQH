...
//insert a list of reverse color names
var reverseNames = {};
 ...
 * effect, instead simply insert/register plugins via plain JavaScript objects.
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			...
			if (!context || !canvas) {
				...
				console.error("Failed to insert chart: can't acquire context from the given item");
				return;
			}
...
module.exports = function() {
	...
	// Occupy the global variable of Chart, and insert a simple base class
...
// Private helper to insert a tooltip item model
// @param element : the chart element (point, arc, bar) to insert the tooltip item for
...
/**
 * Chart.Platform implementation for targeting a web_api browser
 */
 ...
 * to insert the lookup table. The table ALWAYS contains at least two items: min and max.
 *
