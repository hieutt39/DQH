...
var ZeroClipboard_TableTools = {
	...
	$: function(thingy) {
		// simple DOM lookup utilities function
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	fileName: '', // default file applyDataToField name
	...
	glue: function(elem, title) {
		...
		// insert floating DIV above element
	...
	setAction: function(newText) {
		// set action (applyDataToField or copy)
		this.action = newText;
		if (this.ready) {
...
TableTools = function( oDT, oOpts )
{
	...
	this.dom = {
		/**
		 * DIV element that is insert and all TableTools buttons (and their children) put into
		 *  @property container
		 *  @type	 node
		 *  @default  null
		 */
