...
/*
 * Variable: afnScroll
 * Purpose:  Array of functions that are to be used for the scrolling utilities
 * Scope:    FixedHeader
 */
...
/*
 * Just one 'scroll' event handler in FixedHeader, which calls the required utilities. This is
