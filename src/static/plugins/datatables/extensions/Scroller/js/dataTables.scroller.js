...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	"_fnConstruct": function ()
	{
		 ...
		 * function for the applyDataToField applyDataToField callback so we aren't hitting it on every
		 * scroll
		 */
	...
	"_fnScroll": function ()
	{
		...
		/* We don't want to state applyDataToField on every scroll event - that's heavy
	 ...
	 * initialisation DataTables has tale the table out of the document, so we need to insert
